...
CHOICES = (('1','A-'),('2','A+'),('3','AB+'),('4','AB-'),('5','O-'),('6','O+'))
...
class DoctorCreateForm(UserCreateForm):
    ...
    def save(self):
        ...
        user.save()
        data = self.cleaned_data
        doctor = Doctor.objects.create(user=user, department_id=data['department_id'], experience = data['experience'], category = data['category'],
...
class DoctorForm(ModelForm):
    ...
    class Meta:
        model = Doctor
        fields = ('department_id', 'experience', 'category', 'price_of_the_appointement','degree',
